...
def make_transaction(log_obj, account_data, tran_type, amount, **others)
    ...
    if tran_type in settings.TRANSACTION_TYPE:
        ...
        if settings.TRANSACTION_TYPE[tran_type]['action']=='plus':
            ...
            #check credit
            if new_balance<0:
                print('''\033[31;1mYour credit [%s] is not enough for paying [-%s], your current balance is 
        ...
        print("\033[31;1mTransaction typr [%s] is not exist!\033[0m"%tran_type)
